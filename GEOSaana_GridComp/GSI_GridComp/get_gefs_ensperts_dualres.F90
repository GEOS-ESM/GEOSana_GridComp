...
!$$$ end documentation block
  ...
  use hybrid_ensemble_parameters, only: sst_staticB,pblri_staticB,pblrf_staticB
  use hybrid_ensemble_parameters, only: pblsld_staticB,pblgld_staticB,pblrd_staticB
...
!          end do
          ...
          if ((trim(cvars2d(ic2))=='pblri' .or. trim(cvars2d(ic2))=='pblrf' .or. &
               trim(cvars2d(ic2))=='pblsld' .or. trim(cvars2d(ic2))=='pblgld' .or. &
               trim(cvars2d(ic2))=='pblrd')) then
             if ((.not. pblri_staticB .and. trim(cvars2d(ic2))=='pblri') .or. &
                 (.not. pblrf_staticB .and. trim(cvars2d(ic2))=='pblrf') .or. &
                 (.not. pblsld_staticB .and. trim(cvars2d(ic2))=='pblsld') .or. &
                 (.not. pblgld_staticB .and. trim(cvars2d(ic2))=='pblgld') .or. &
                 (.not. pblrd_staticB .and. trim(cvars2d(ic2))=='pblrd') ) then
!$omp parallel do schedule(dynamic,1) private(i,j)
                do j=1,jm
                   do i=1,im
                      ...
                      if (trim(cvars2d(ic2))=='pblrf' .and. zero_en_perts_pblrf_land) then
