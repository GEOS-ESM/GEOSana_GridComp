...
!   2017-12-05  Wargan   - added ozone limb obs: ompslp, lims, mipas, uars-mls
...
!          set up ozone (sbuv/omi/mls) data
              ...
              if (obstype == 'o3lev' .or. index(obstype,'mls')/=0 .or. index(obstype,'ompslp')/=0 .or. &
                   obstype == 'lims' .or. obstype == 'uarsmls' .or. obstype == 'mipas') then
