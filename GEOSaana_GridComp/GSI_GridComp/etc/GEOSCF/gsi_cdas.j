...
setenv  EXPDIR `pwd`
#setenv FVROOT        /discover/nobackup/cakelle2/CDAS/code/GEOSadas/install 
# why???
...
#setenv  FVBUILD /discover/nobackup/cakelle2/CDAS/code/GEOSadas/install 
...
#   /bin/mv satbias_pc.out satbias_pc
   ...
   # this is for NO2/SO2
   # Create analysis file for use by GEOS: this includes the nearest observation hour for each location with an increment
