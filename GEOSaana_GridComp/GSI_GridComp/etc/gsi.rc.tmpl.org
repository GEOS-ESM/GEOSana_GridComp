...
@RADBC   diag_precon=.true.,step_start=1.e-3,emiss_bc=.true.,
 ...
 &OBSQC
   ...
   use_poq7=.true.,qc_noirjaco3=.false.,qc_satwnds=.true.,cld_det_dec2bin=.true.,
   half_goesr_err=.false.,max_tail=15000,
!  tcp_ermin=0.75,tcp_ermax=0.75,
   >>>AIRCFT_BIAS<<<
 /
 &OBS_INPUT
   dmesh(1)=145.0,dmesh(2)=150.0,dmesh(3)=180.0,dmesh(4)=5000.0,time_window_max=3.0,
 /
OBS_INPUT::
!  dfile          dtype       dplat       dsis                  dval    dthin  dsfcalc  obsclass
   uprair         ps          null        ps                    0.0     0      0        ncep_uprair_bufr
   uprair         t           null        t                     0.0     0      0        ncep_uprair_bufr
   uprair         q           null        q                     0.0     0      0        ncep_uprair_bufr
   uprair         uv          null        uv                    0.0     0      0        ncep_uprair_bufr
   prepbufr       ps          null        ps                    0.0     4      0        ncep_prep_bufr
   prepbufr       t           null        t                     0.0     4      0        ncep_prep_bufr
   prepbufr_profl t           prof        t                     0.0     4      0        ncep_acftpfl_bufr
   prepbufr       q           null        q                     0.0     4      0        ncep_prep_bufr
   prepbufr       uv          null        uv                    0.0     4      0        ncep_prep_bufr
   prepbufr_profl uv          prof        uv                    0.0     4      0        ncep_acftpfl_bufr
   prepbufr       spd         null        spd                   0.0     4      0        ncep_prep_bufr
   radarbufr      rw          null        rw                    0.0     4      0        ncep_radar_bufr
   prepbufr       dw          null        dw                    0.0     4      0        ncep_prep_bufr
   mlstbufr       t           aura        t                     1.0     4      0        gmao_mlst_bufr
!! prepbufr       sst         null        sst                   0.0     4      0        ncep_prep_bufr
   modsbufr       sst         mods        sst                   0.0     4      0        to_be_done
   prepbufr       pw          null        pw                    0.0     4      0        ncep_prep_bufr
...
!  mlsoztext      o3lev       aura        o3lev_aura            0.0     0      0        test
   ...
   tcvitl         tcp         null        tcp                   0.0     4      0        ncep_tcvitals
