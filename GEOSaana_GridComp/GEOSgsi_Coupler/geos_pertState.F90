...
!-------------------------------------------------------------------------
  ...
  character(len=*),parameter::  pblkh_GSIpert='pblkh'	! = ?
  ...
  character(len=*),dimension(5),parameter:: var2dList_GSIpert = &
    (/ps_GSIpert, sst_GSIpert, pblri_GSIpert, pblrf_GSIpert, pblkh_GSIpert /)
  ...
  character(len=*),parameter:: pblkh_GCMpert='pblkh'      ! = zpbl
