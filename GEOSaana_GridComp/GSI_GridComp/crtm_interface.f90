...
subroutine call_crtm(obstype,obstime,data_s,nchanl,nreal,ich, &
                   ...
                   emissivity_k,temp,wmix,jacobian,error_status,radmod,tsim_clr, &
...
!=================================
!!!! GMAO's current FP ==> Switch to NCEP's Vlap version will result in non-zero(but very small) diff in most of all satellite radiance DA
