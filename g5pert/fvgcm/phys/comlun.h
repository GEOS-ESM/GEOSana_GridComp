...
C
     ...
     $              nrefrq     ,rg3num  ,mresfq,lutag(99),rgnht(ptapes)
C
...
C
      ...
      integer ninit      ! initial dataset unit
...
C
      ...
      integer rg3num     ! number of temporary secondary regen files
...
C 
      ...
      character*5 rg3ext ! file extension for secondary regen files
