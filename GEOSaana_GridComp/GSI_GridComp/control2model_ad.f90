...
real(r_kind),pointer,dimension(:,:)   :: rv_pblri=>NULL()
real(r_kind),pointer,dimension(:,:)   :: rv_pblrf=>NULL()
real(r_kind),pointer,dimension(:,:)   :: rv_pblsld=>NULL()
real(r_kind),pointer,dimension(:,:)   :: rv_pblgld=>NULL()
real(r_kind),pointer,dimension(:,:)   :: rv_pblrd=>NULL()
