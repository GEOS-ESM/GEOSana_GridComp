...
! set passed variables to public
  ...
  public :: inf_ensprd_pblkh
  public :: bens_recenter
  public :: upd_ens_spread
  public :: upd_ens_localization

  logical l_hyb_ens,uv_hyb_ens,q_hyb_ens,oz_univ_static,sst_staticB,pblri_staticB,pblrf_staticB,pblkh_staticB
...
!          nhoriz = (sp_loc%jcap+1)*(sp_loc%jcap+2) for global
  ...
  logical inf_ensprd_pblri,inf_ensprd_pblrf,inf_ensprd_pblkh
...
!$$$ end documentation block
  ...
  inf_ensprd_pblkh=.false.   ! inflate ensemble spread near pblkh
