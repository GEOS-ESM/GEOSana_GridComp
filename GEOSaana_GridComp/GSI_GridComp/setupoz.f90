...
! Declare local variables  
  ...
  integer(i_kind) k,j,nz,jc,idia,irdim1,istatus,ioff0,ioff1
...
!          Map observation pressure to guess vertical coordinate
        ...
        if (obstype /= 'omieff' .and. obstype /= 'tomseff' &
             .and. obstype /= 'ompsnmeff' ) then
...
! Declare local variables  
  ...
  integer(i_kind) k,j,idia,irdim1,ioff0,ioff1
