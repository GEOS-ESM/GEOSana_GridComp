       ...
       do ic2=1,nc2d
          ...
          select case ( trim(StrUpCase(cvars2d(ic2))) )
             ...
             case DEFAULT
                ...
                !PBLRI, PBLRF, PBLSLD, PBLGLD, PBLRD
                do j=1,jm
                   do i=1,im
                      a_en(n)%r3(ipx)%q(i,j,1)=a_en(n)%r3(ipx)%q(i,j,1) &
                         +work_ens%r2(ipic)%q(i,j)*en_perts(n,ibin)%r2(ipic)%qr4(i,j)
     ...
     do ii=1,nsubwin
        ...
        do ic2=1,nc2d
           ...
           if ( trim(StrUpCase(cvars2d(ic2)))=='PBLRI' .or. trim(StrUpCase(cvars2d(ic2)))=='PBLRF' & 
              .or. trim(StrUpCase(cvars2d(ic2)))=='PBLSLD' .or. trim(StrUpCase(cvars2d(ic2)))=='PBLGLD' &
              .or. trim(StrUpCase(cvars2d(ic2)))=='PBLRD') then
              ...
              if( (pblri_staticB .and. trim(StrUpCase(cvars2d(ic2)))=='PBLRI') .or. &
                  ...
                  (pblsld_staticB .and. trim(StrUpCase(cvars2d(ic2)))=='PBLSLD') .or. &
                  (pblgld_staticB .and. trim(StrUpCase(cvars2d(ic2)))=='PBLGLD') .or. &
                  (pblrd_staticB .and. trim(StrUpCase(cvars2d(ic2)))=='PBLRD') ) then
                 cycle
              else
